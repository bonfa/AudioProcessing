...
%I passi principali dell'algoritmo consistono nella registrazione del suono tramite microfono, calcolo della trasformata discreta di Fourier, isolamento di una stima della frequenza fondamentale tramite il metodo \emph{Harmonic Product Spectrum}, interpolazione dei valori della funzione ottenuta per migliorare la precisione dell'algoritmo, individuazione della frequenza fondamentale, calcolo della differenza tra la frequenza fondamentale e la frequenza di riferimento e rappresentazione di questi ultimi due dati.
